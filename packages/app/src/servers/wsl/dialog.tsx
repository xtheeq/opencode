      ...
      fallback={
        <Dialog fit class="settings-wsl-dialog">
          <Show
            ...
            fallback={<div class="settings-wsl-loading">{controller.loadError()}</div>}
          >
          ...
          >
            <DialogBody class="settings-wsl-dialog-body">
              <div class="settings-wsl-section-header">
                <span class="settings-wsl-section-title">{language.t("wsl.onboarding.installedDistros")}</span>
              ...
              <Show when={model().installableDistros.length > 0}>
                ...
                >
                  ...
                  <span class="settings-wsl-catalog-copy">
                    <span class="settings-wsl-catalog-title">{language.t("wsl.onboarding.needAnotherDistro")}</span>
