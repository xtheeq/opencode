...
export function formReply(form: FormInfo, state: FormBodyState): FormReplyValue | undefined {
...
export function formPick(state: FormBodyState, form: FormInfo): FormBodyState {
  ...
  if (field.type === "multiselect") {
    return {
      ...
      answers: {
        ...state.answers,
        [field.key]: formToggleMultiselect(state.answers[field.key], String(row.value)),
      },
      error: "",
    };
  }
