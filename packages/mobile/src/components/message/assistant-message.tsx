...
export function AssistantMessage({
  ...
  return (
    <>
      ...
      {message.retry && (
        <Text variant="caption">
          {message.retry.attempt}: {message.retry.error.message}
        </Text>
      )}
      ...
      {message.tokens && (
        <Text variant="caption">
          in: {message.tokens.input} out: {message.tokens.output} reasoning:{" "}
      ...
      {duration && <Text variant="caption">{duration}</Text>}
      {message.finish && <Text variant="caption">{message.finish}</Text>}
    </>
  );
}
