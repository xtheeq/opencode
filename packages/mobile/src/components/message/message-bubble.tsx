...
export function MessageBubble({ message }: { message: SessionMessageInfo }) {
  switch (message.type) {
    ...
    case "system":
    case "synthetic": return <SystemMessage message={message} />
    case "shell": return <ShellMessage message={message} />
    case "compaction": return <CompactionMessage message={message} />
    case "agent-switched":
    case "model-switched": return <SwitchMessage message={message} />
    case "skill": return <SkillMessage message={message} />
  }
